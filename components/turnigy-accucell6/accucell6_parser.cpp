...
Accucell6_Parser::Accucell6_Parser() :
    message_buffer_({0}),
...
bool Accucell6_Parser::add_bytes_and_chack_for_complete_message(const uint8_t *new_bytes, const std::size_t len) {
  bool ret = false;

  if (len != 0) {
    if (this->message_buffer_index_ + len >= Accucell6_Parser::MESSAGE_BUFFER_LEN) {
...
bool Accucell6_Parser::get_is_charging() const {
  return this->charging_;
}

bool Accucell6_Parser::get_is_cycling() const {
  return this->cycling_;
}

float Accucell6_Parser::get_target_battery_current() const {
  if (running_) {
    switch (this->menu_mode_)
    {
    case Accucell6_Parser::MENU_MODE_CONFIG:
      return 0.0;
    
    case Accucell6_Parser::MENU_MODE_LI:
      return this->charging_ ? this->set_current_li_charge_ : -this->set_current_li_discharge_;
    
    case Accucell6_Parser::MENU_MODE_NIMH:
      return this->charging_ ? this->set_current_nimh_charge_ : -this->set_current_nimh_discharge_;
    
    case Accucell6_Parser::MENU_MODE_NICD:
      return this->charging_ ? this->set_current_nicd_charge_ : -this->set_current_nicd_discharge_;
    
    case Accucell6_Parser::MENU_MODE_PB:
      return this->charging_ ? this->set_current_pb_charge_ : -this->set_current_pb_charge_;
    
    case Accucell6_Parser::MENU_MODE_SAVE:
    case Accucell6_Parser::MENU_MODE_LOAD:
    default:
      return 0.0;
    }
  } else {
...
bool Accucell6_Parser::get_cycle_starts_with_charge() const {
  return this->cycle_mode_charge_discharge_;
}

uint8_t Accucell6_Parser::get_cycle_count() const {
  return this->cycle_count_;
}

uint8_t Accucell6_Parser::get_target_cell_count() const {
  if (running_) {
    switch (this->menu_mode_)
    {
    case Accucell6_Parser::MENU_MODE_CONFIG:
...
uint8_t Accucell6_Parser::get_menu_mode() const {
  return this->menu_mode_;
}

bool Accucell6_Parser::get_is_running() const {
  return this->running_;
}

float Accucell6_Parser::get_measured_battery_current() const {
  if (running_) {
...
float Accucell6_Parser::get_measured_battery_voltage() const {
  if (running_) {
...
float Accucell6_Parser::get_measured_input_voltage() const {
  return this->measured_input_voltage_;
}

float Accucell6_Parser::get_measured_charge() const {
  if (running_) {
...
float Accucell6_Parser::get_measured_cell_voltage(std::size_t index) const {
  if (running_) {
    return index < Accucell6_Parser::MAX_CELL_COUNT ? this->measured_cell_voltage_Li_[index] : 0.0;
  } else {
    return 0.0;
  }
}

uint16_t Accucell6_Parser::get_elapsed_minutes() const {
  if (running_) {
...
bool Accucell6_Parser::compare_checksum() const {
  uint16_t check = 0;
  uint16_t sum = 0;
...
uint8_t Accucell6_Parser::sanitize_data_byte(const std::size_t index) const {
  return this->message_buffer_[index] & 0x7F;
}

float Accucell6_Parser::parse_A_from_dA(const std::size_t index) const {
  return this->sanitize_data_byte(index) * 0.1;
}

float Accucell6_Parser::parse_A_from_A_and_cA(const std::size_t index) const {
  return this->sanitize_data_byte(index) + this->sanitize_data_byte(index+1) * 0.01;
}

float Accucell6_Parser::parse_V_from_daV_and_dV(const std::size_t index) const {
  return this->sanitize_data_byte(index) * 10.0 + this->sanitize_data_byte(index+1) * 0.1;
}

float Accucell6_Parser::parse_V_from_V_and_cV(const std::size_t index) const {
  return this->parse_A_from_A_and_cA(index);
}

float Accucell6_Parser::parse_Ah_from_dAh_and_mAh(const std::size_t index) const {
